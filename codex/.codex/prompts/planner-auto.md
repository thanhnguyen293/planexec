...
400 lines). Report the file path, then proceed directly to the plan
review - do NOT wait for approval.

## Step 4.5 — Plan review
Spawn the `plan-reviewer` subagent with ONLY the plan file path(s)
