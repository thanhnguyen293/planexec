---
description: Reviews a detailed plan file with a clean context before auto-dispatch - checks self-containedness, ticket coverage, format compliance and verifiability
mode: subagent
hidden: true
